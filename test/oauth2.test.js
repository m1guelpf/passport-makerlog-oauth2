...
var chai = require('chai')
  , Strategy = require('../lib').MakerLogOAuth2Strategy;
...
describe('Strategy', function() {
  ...
  describe('constructed', function() {
    ...
    it('should be named makerlog', function() {
      expect(strategy.name).to.equal('makerlog');
    });
  });
  ...
  describe('authorization request without options', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://api.getmakerlog.com/oauth2/authorize?response_type=code&client_id=ABC123');
    });
  });
  ...
  describe('authorization request with extra parameters', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://api.getmakerlog.com/oauth2/authorize?foo=bar&response_type=code&client_id=ABC123');
    });
  });
  ...
  describe('authorization request with scopes', function() {
    ...
    it('should be redirected', function() {
      expect(url).to.equal('https://api.getmakerlog.com/oauth2/authorize?scope=weight%20profile&response_type=code&client_id=ABC123');
    });
  });
